...
These are the microinteraction signatures of generated code. The slop test in [`SKILL.md`](../UPSTREAM_SKILL.md) checks for them; treat any one as a critical finding.
